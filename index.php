...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="assets/img/love.jpg"/>
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="index.php">HEARTSTRINGS</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto my-2 my-lg-0">
                ...
                ?>
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#portfolio">View Profiles</a></li>
                <?php if (isset($_SESSION['role']) && $_SESSION['role'] == 2) :
                    echo '<li class="nav-item"><a class="nav-link js-scroll-trigger" href="favorite_view.php">Favorites</a></li>';
                else :
                    echo '<li class="nav-item"><a class="nav-link js-scroll-trigger" style="display: none" href="">Favorites</a></li>';
                endif;
                ?>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form method="post">
                    ...
                    <button class="btn login" id="b2" type="submit" name="login_user">Login</button>
                    <br><br>
                    <p>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form action="index.php" method="post" enctype="multipart/form-data">
                    ...
                    <?php include('errors_profile.php'); ?>
                    <div class="hiddenFileInputContainter">
                        <?php while ($row = mysqli_fetch_array($result)) { ?>
                        <img class="fileDownload" name="profile_photo"
                             src="assets/img/profiles/<?php echo $row["Photo"]; ?>">
                    ...
                    <div class="input-group">
                        <?php if (isset($_SESSION['UserId']) && $_SESSION['role'] == 1) {
                            echo 'Wanna switch to premiun account?<a href="premium.php?id=<?php echo $_SESSION[\'UserId\']; ?>" style="color:darkblue;"> Click me!</a>';
                        }
                        ?>
                    </div>
                    <div class="input-group">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 text-center">
                <div class="mt-5">
                    ...
                    <p class="text-muted mb-0">Make room in your calendars! Come to our parties and activities dedicated
                        to singles of your age near you.</p>
            ...
            <div class="col-lg-3 col-md-6 text-center">
                <div class="mt-5">
                    ...
                    <br><br>
                    <p class="text-muted mb-0">Every year nearly 10,000 people meet each other and found their perfect
                        match.</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                ...
                <hr disabled="yes"/>
                <p class="text-muted mb-5">Wanna date someone? Visit Heartstrings and find love from someone who matches
                    you!</p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-4 mr-auto text-center">
                ...
                <a class="d-block" href="mailto:contact@yourwebsite.com">contactus.heartstrings@gmail.com</a>
            </div>
        </div>
    </div>
</section>
...
<footer class="bg-light py-5">
    <div class="container">
        <div class="small text-center text-muted">Copyright © 2020 - Heartstrings</div>
    </div>
</footer>
<!-- Bootstrap core JS-->
